...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-8 font-['Founders_Grotesk_XCond-Bold']">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[8vw] uppercase leading-none -mb-10">Eye-</h1>
          <h1 className="text-[8vw] uppercase leading-[3.2] -mb-10 lg:leading-none sm:leading-[14vw]">
            Opening
          </h1>
        </div>
        <div className="mb-15">
          ...
          <div className="text-gray-400 text-lg font-[Neue_Montreal] mt-10 leading-6">
            <p>&copy; ochi design 2025. Legal Terms</p>
            <p>Website by Obys</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-1/2">
        ...
        <div className="dets font-[Neue_Montreal] mt-10 flex flex-col gap-4">
          {[
            {
              name: "Facebook",
            ...
            { name: "Behance", href: "https://www.behance.net/ochi_design" },
            {
              name: "Linkedin",
              href: "https://www.linkedin.com/company/ochi-design/",
            },
          ].map((item, index) => (
            <div
              key={index}
            ...
            >
              <a
                ...
                className="inline-block text-xl font-light transition-colors duration-300 group-hover:text-white"
              >
                {item.name}
              </a>
              <span className="absolute bottom-0 left-0 h-[1.5px] w-full bg-white scale-x-0 group-hover:scale-x-100 origin-right group-hover:origin-left transition-transform duration-500 ease-in-out"></span>
            </div>
          ))}
        </div>
      </div>
